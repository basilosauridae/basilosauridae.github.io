...
- 链表：一种线性数据结构，由一系列节点组成。每个节点包含数据和指向下一个节点的**引用**（也称指针，不同编程语言英文不同，但一般多用next表示）。<u>节点在内存中不连续</u>，**而是通过next找到并连接**。
  ...
  :::
  ![placeholder](https://cetacea-1304984885.cos.ap-shanghai.myqcloud.com/pieces/Snipaste_2025-06-19_01-04-18.jpg)
  ![placeholder](https://cetacea-1304984885.cos.ap-shanghai.myqcloud.com/pieces/Snipaste_2025-06-19_01-04-58.jpg)
...
![placeholder](https://cetacea-1304984885.cos.ap-shanghai.myqcloud.com/pieces/Snipaste_2025-04-18_21-04-15.jpg)
