...
![placeholder](https://cetacea-1304984885.cos.ap-shanghai.myqcloud.com/pieces/Snipaste_2024-03-19_16-32-10.jpg)
...
![placeholder](https://cetacea-1304984885.cos.ap-shanghai.myqcloud.com/pieces/Snipaste_2024-04-17_15-14-26.jpg)
...
![placeholder](https://cetacea-1304984885.cos.ap-shanghai.myqcloud.com/pieces/Snipaste_2024-04-17_15-18-55.jpg)
...
1️⃣首先，根据新列表剩余的节点数量，创建一个 source 数组，并将数组填满 -1
  ![placeholder](https://cetacea-1304984885.cos.ap-shanghai.myqcloud.com/pieces/Snipaste_2024-04-17_17-49-37.jpg)
...
3️⃣ 找到位置后，观察重新赋值的`source`,若是全新的节点，初始值 -1 ，从而判断谁是全新的，谁是可复用的。
  ![placeholder](https://cetacea-1304984885.cos.ap-shanghai.myqcloud.com/pieces/Snipaste_2024-04-17_18-00-28.jpg)
...
1️⃣ 一旦需要进行DOM移动，我们首先要做的就是找到`source的最长递增子序列`。
  ...
  ![placeholder](https://cetacea-1304984885.cos.ap-shanghai.myqcloud.com/pieces/Snipaste_2024-04-17_18-46-00.jpg)
...
2️⃣ 我们根据source，对新列表进行重新编号。从后向前遍历 source 的每一项，会出现三种情况:
  ...
  ![placeholder](https://cetacea-1304984885.cos.ap-shanghai.myqcloud.com/pieces/Snipaste_2024-04-17_18-49-09.jpg)
