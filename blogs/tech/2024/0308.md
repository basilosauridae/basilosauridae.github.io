...
![placeholder](https://cetacea-1304984885.cos.ap-shanghai.myqcloud.com/pieces/Snipaste_2024-03-15_18-49-48.jpg)
...
3️⃣使用以上四步对比，去寻找 key 相同的可复用节点，当在某一步找到了就停止后面的寻找，如下图:
  ...
  ![placeholder](https://cetacea-1304984885.cos.ap-shanghai.myqcloud.com/pieces/Snipaste_2024-04-11_20-05-58.jpg)
  对比顺序代码如下：
...
6️⃣至此整体的循环我们就全部完成了，下面我们需要考虑这样两个问题：
  ...
  **🔴首先看第一个问题:**
  ...
  🔴**进入第二次循环：**
  ![placeholder](https://cetacea-1304984885.cos.ap-shanghai.myqcloud.com/pieces/Snipaste_2024-04-12_10-13-22.jpg)
  在第二步发现，`oldEndNode`和`newEndNode`是复用节点（如上图c节点）。原本在旧列表中就是尾部，在新列表中也是尾部，说明C节点不需要移动。
  `oldStartNode`和`newStartNode`同理。

  🔴**进入第三次循环：**
  ![placeholder](https://cetacea-1304984885.cos.ap-shanghai.myqcloud.com/pieces/Snipaste_2024-04-12_16-38-31.jpg)
  在第三步发现，a为复用节点，将 DOM-A 移动到 DOM-B 即可。
  
  🔴**进入最后一次循环：**
  ![placeholder](https://cetacea-1304984885.cos.ap-shanghai.myqcloud.com/pieces/Snipaste_2024-04-12_16-46-07.jpg)
