...
<iframe frameborder="no" border="0" marginwidth="0" marginheight="0" width=330 height=86 src="//music.163.com/outchain/player?type=2&id=2738338863&auto=1&height=66"></iframe>
...
📫·[Github](https://github.com/Basilosauridae)·[知乎](https://www.zhihu.com/people/ying-zi-74-41)·[Steam](https://steamcommunity.com/profiles/76561199024540854/)·
...
![placeholder](https://cetacea-1304984885.cos.ap-shanghai.myqcloud.com/project/006.png)
...
![placeholder](https://cetacea-1304984885.cos.ap-shanghai.myqcloud.com/memories/001.jpg)
  
### 项目业务背景

小箱单是针对中小制造业,以`管控仓库物流`、`车间管理透明化`、`规范业务流程`为目标，打造以现场驱动、聚焦场内物流的全链路执行系统。

![placeholder](https://cetacea-1304984885.cos.ap-shanghai.myqcloud.com/project/003.jpg)
两端控制:管理人员通过web端管理`人、物、箱、路线`，通过权限控制，定制作业路线，展示可视化报表；操作人员通过`小程序/PDA`实现`物料装箱/搬运/报工`等功能。
![placeholder](https://cetacea-1304984885.cos.ap-shanghai.myqcloud.com/project/009.jpg)
...
![placeholder](https://cetacea-1304984885.cos.ap-shanghai.myqcloud.com/project/008.jpg)
...
![placeholder](https://cetacea-1304984885.cos.ap-shanghai.myqcloud.com/project/012.png)

## 边缘计算盒(AIoT)

>vue3.0+TypeScript+Vite 

![placeholder](https://cetacea-1304984885.cos.ap-shanghai.myqcloud.com/project/001.png)
...
- 并封装了通用组件：
![placeholder](https://cetacea-1304984885.cos.ap-shanghai.myqcloud.com/project/002.png)
...
![placeholder](https://cetacea-1304984885.cos.ap-shanghai.myqcloud.com/project/014.png)
...
![placeholder](https://cetacea-1304984885.cos.ap-shanghai.myqcloud.com/project/016.png)
...
![placeholder](https://cetacea-1304984885.cos.ap-shanghai.myqcloud.com/project/015.png)
...
![placeholder](https://cetacea-1304984885.cos.ap-shanghai.myqcloud.com/project/017.gif)
